    ...
    <div className="restaurant-status-grid">
            ...
            >
              ...
              <div className="metrics-grid">
                ...
                <div className="metric">
                  <div className="metric-icon">💰</div>
                  <div className="metric-content">
                    <div className="metric-value">{formatMoney(restaurant.metrics.todayRevenue)}</div>
                ...
                <div className="order-details-dropdown">
                  <div className="panel-content">
                    ...
                    <div className="detail-section">
                      ...
                      <p><strong>Today's Revenue:</strong> {formatMoney(restaurant.metrics.todayRevenue)}</p>
                    </div>
                    <div className="detail-section">
                      <h4>Quick Actions</h4>
      ...
      <div className="grid-summary">
        ...
        <div className="summary-stat">
          ...
          <span className="summary-value">
            {formatMoney(restaurants.reduce((total, r) => total + r.metrics.todayRevenue, 0))}
          </span>
        </div>
        <div className="summary-stat">
