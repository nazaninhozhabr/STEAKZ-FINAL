...
const NAV_OPTIONS = {
  ...
  CASHIER: [
    ...
    { label: 'Home', path: '/' },
    { label: 'Menu', path: '/menu' },
    { label: 'Cart', path: '/cart', badge: true },
...
const Navbar: React.FC = () => {
  ...
  const badgeCounts: Record<string, number> = {
    'Reports': 2,
    'Orders': 3,
    'Cart': user?.role === 'CUSTOMER' ? getTotalItems() : 0,
  };
  ...
  const getText = (key: string) => {
    ...
    return texts[settings.language]?.[key] || texts.en[key] || key;
  };
        ...
        <div style={containerStyle}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>            {/* Language Dropdown */}
            ...
            >
              ...
              <option value="fa" style={{ backgroundColor: '#0a0a0a', color: '#ffffff' }}>FA</option>
              ...
              >
                ...
                <div style={{ padding: '8px 16px', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
                  ...
                  >
                    ...
                    <option value="IRR" style={{ backgroundColor: '#1a1a1a', color: '#ffffff' }}>IRR - تومان</option>
        ...
        <div style={mobileMenuStyle}>
          ...
          <div style={{ padding: '20px 0', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
            ...
            >
              ...
              <option value="fa" style={{ backgroundColor: '#0a0a0a', color: '#ffffff' }}>فارسی</option>
          ...
          <div style={{ padding: '20px 0', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
            ...
            >
              ...
              <option value="IRR" style={{ backgroundColor: '#0a0a0a', color: '#ffffff' }}>IRR - تومان</option>
