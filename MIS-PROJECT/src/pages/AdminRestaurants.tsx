          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {branches.map((branch) => (
              <tr key={branch.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">{branch.status === 'inactive' ? <span className="text-red-500">Inactive</span> : <span className="text-green-600">Active</span>}</td>
              </tr>
            ))}
          </tbody>
        </table>
