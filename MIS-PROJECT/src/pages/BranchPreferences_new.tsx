                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm mb-1 flex items-center gap-3 transition-colors ${
                      activeSection === tab.id
                        ? 'bg-pink-50 text-pink-700 font-medium dark:bg-blue-900/30 dark:text-blue-300'
                          ...
                          <button
                            ...
                            className={`p-3 rounded-lg border text-sm capitalize flex items-center justify-center gap-2 transition-colors ${
                              preferences.theme === theme
                                ? 'border-pink-500 bg-pink-50 text-pink-700 dark:border-blue-400 dark:bg-blue-900/30 dark:text-blue-300'
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          />
                          <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink-300 dark:peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-pink-600 dark:peer-checked:bg-blue-600"></div>
                        </label>
                      </div>
          ...
          <div className="p-4">
            <div className="flex flex-col sm:flex-row gap-3 max-w-md">
              <button 
                onClick={handleSave}
                disabled={isSaving}
                className="bg-pink-600 hover:bg-pink-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white px-4 py-2 rounded-md disabled:opacity-50 flex-1 text-sm font-medium transition-colors"
              >
              ...
              <button
                onClick={handleReset}
                disabled={isSaving}
                className="bg-pink-100 hover:bg-pink-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/40 text-pink-700 dark:text-blue-200 px-4 py-2 rounded-md disabled:opacity-50 flex-1 text-sm font-medium transition-colors"
              >
                Reset to Default
              </button>
            </div>
