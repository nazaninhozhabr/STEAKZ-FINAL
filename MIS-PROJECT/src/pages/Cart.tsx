...
const Cart: React.FC = () => {
  ...
  useEffect(() => {
    if (!showOrderForm || user?.role !== 'CUSTOMER') return;
  ...
  }, [showOrderForm, user?.role, user?.branchId]);
  ...
  const handlePlaceOrder = async () => {
    ...
    if (user?.role === 'CUSTOMER' && !selectedBranchId) {
      alert('Please select a branch');
      return;
    }

    try {
      // For customers, use selected branch. For cashiers, use their assigned branch.
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <select
                    ...
                    style={{
                      ...
                      borderRadius: 6,
                      fontSize: 14,
                      background: loadingBranches ? '#f3f4f6' : '#fff'
                    }}
                  >
