...
const testimonials = [
  { name: 'علی رضائی', text: 'Best restaurant in the city! Absolutely delicious food and exceptional service. Everything exceeded my expectations!', rating: 5 },
  { name: 'فاطمه نوری', text: 'An unforgettable experience for our family! Beautiful ambiance and incredibly tasty dishes. We absolutely love this place!', rating: 5 },
  { name: 'حسن احمدی', text: 'Professional service and premium quality food! Every visit makes me feel welcomed. Highly recommended to everyone!', rating: 5 }
];
...
const HQManagerDashboard: React.FC = () => {
  ...
  const formatPrice = (amount: number) => {
    return formatCurrency(amount, settings.currency, settings.language);
  };
          ...
          >
            ...
            <div style={{ position: 'relative' }}>
              ...
              <p style={{
                ...
                {financialData ? formatPrice(financialData.totalSalesToday || 0) : formatCurrency(0, settings.currency, settings.language)}
              </p>
              <p style={{
                fontSize: '0.875rem',
                color: isDarkMode ? '#cbd5e1' : '#64748b',
        ...
        <div className="mt-10">
          <div style={cardStyle} className="hover:shadow-xl transition-all duration-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <Link 
                to="/branches" 
                className="group p-6 bg-gradient-to-br from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white rounded-xl text-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
              >
          ...
          >
            ...
            <div style={{ position: 'relative' }}>
              ...
              <p style={{
                ...
                {dailySales ? formatPrice(dailySales.totalSales) : formatCurrency(0, settings.currency, settings.language)}
              </p>
              <div style={{
                fontSize: '0.875rem',
                color: isDarkMode ? '#cbd5e1' : '#64748b',
...
const Home: React.FC = () => {
  ...
  const getImageForDish = (category: string, name: string) => {
    const categoryImages: Record<string, string> = {
      'steaks': 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?auto=format&fit=crop&w=800&q=90',
      'beef': 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?auto=format&fit=crop&w=800&q=90',
      'chicken': 'https://images.unsplash.com/photo-1598103442097-8b74394b95c6?auto=format&fit=crop&w=800&q=90',
      'seafood': 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=800&q=90',
      'fish': 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=800&q=90',
      'appetizers': 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=800&q=90',
      'desserts': 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=90',
      'chocolate': 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=90',
      'fondant': 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=90',
      'beverages': 'https://images.unsplash.com/photo-1517668808822-9ebb02ae2a0e?auto=format&fit=crop&w=800&q=90',
      'salads': 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=90',
      'caesar': 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=90',
      'pasta': 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?auto=format&fit=crop&w=800&q=90',
      'burgers': 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=90',
      'pizza': 'https://images.unsplash.com/photo-1555939594-58d7cb561a1a?auto=format&fit=crop&w=800&q=90',
      'soup': 'https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&w=800&q=90',
      'sandwich': 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?auto=format&fit=crop&w=800&q=90'
    };
  ...
  const containerStyle: React.CSSProperties = {
    backgroundColor: isDarkMode ? '#0f0f0f' : '#fffafb',
  ...
  const heroStyle: React.CSSProperties = {
    position: 'relative',
    height: '100vh',
    background: 'linear-gradient(rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.45)), url("https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=2070&q=80") center/cover',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    color: '#ffffff',
  ...
  const primaryButtonStyle: React.CSSProperties = {
    ...
    transition: 'all 0.3s ease',
    boxShadow: '0 4px 15px rgba(216, 27, 96, 0.25)',
    cursor: 'pointer'
  };
  ...
  const reviewSectionStyle: React.CSSProperties = {
    backgroundColor: isDarkMode ? '#1a1a1a' : '#fffafb',
    padding: '60px 20px',
    textAlign: 'center'
  };
  ...
  return (
    <div style={containerStyle}>      {/* Hero Section */}
      ...
      <section style={{ ...sectionStyle, backgroundColor: isDarkMode ? '#111111' : '#fffafb' }}>
            ...
            featuredDishes.map((dish, index) => (
              ...
              >                <div style={dishBadgeStyle}>{getBadgeForDish(dish.category, dish.name)}</div>
                ...
                <div style={dishContentStyle}>
                  ...
                  <div style={dishPriceStyle}>{formatCurrency(dish.price, settings.currency, settings.language)}</div>
                </div>
              </div>
            ))
          ) : (
      ...
      {/* Location CTA */}
      <section style={{ ...sectionStyle, backgroundColor: isDarkMode ? '#111111' : '#fffafb', textAlign: 'center' }}>
        ...
        <div style={footerContentStyle}>          <div style={footerSectionStyle}>
            ...
            {branchLoading ? (
              ...
              <>
                ...
                <p style={footerTextStyle}>Oxford Street 123, W1D 2HQ London, United Kingdom</p>
              </>
            )}
          </div>
        </div>
