...
const MyOrders: React.FC = () => {
  ...
  const heroStyle: React.CSSProperties = {
    background: isDarkMode
      ...
      : 'linear-gradient(135deg, #fffafb 0%, #fff5f7 100%)',
  ...
  const heroTitleStyle: React.CSSProperties = {
    ...
    fontWeight: '700',
    marginBottom: '1rem',
    textShadow: isDarkMode ? '2px 2px 4px rgba(0, 0, 0, 0.7)' : 'none'
  };
  ...
  const filterButtonStyle = (active: boolean): React.CSSProperties => ({
    ...
    backgroundColor: active ? '#d81b60' : (isDarkMode ? '#333' : '#f8f9fa'),
                ...
                <div style={itemsContainerStyle}>
                  ...
                  {order.items.map(item => (
                    <div key={item.id} style={itemRowStyle}>
                      ...
                      <div style={{ fontWeight: '700', color: '#d81b60', fontSize: '1.1rem' }}>
                  ...
                  <div style={totalStyle}>
                    <span>{t('total')}:</span>
                    <span>{formatCurrency(order.totalAmount, settings.currency, settings.language)}</span>
                  </div>
                </div>
              </div>
            ))}
