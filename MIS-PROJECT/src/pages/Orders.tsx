...
const Orders: React.FC = () => {
          ...
          <body>
            ...
            <div class="items">
              ...
              ${order.items.map(item => `
                <p>${item.quantity}x ${item.menuItem.name} - €${(item.unitPrice * item.quantity).toFixed(2)}</p>
              `).join('')}
            </div>
            <div class="total">
  ...
  const filterButtonStyle = (active: boolean): React.CSSProperties => ({
    ...
    borderRadius: '25px',
    cursor: 'pointer',
    transition: 'all 0.3s ease',    backgroundColor: active ? '#d81b60' : (isDarkMode ? '#333' : '#f8f9fa'),
  ...
  if (error) {
    return (
      <div style={containerStyle}>
        <div style={{ textAlign: 'center', padding: '60px 20px', color: '#d81b60' }}>
              ...
              >
                ...
                <div style={orderDetailStyle}>
                  ...
                  <div style={detailItemStyle}>
                    ...
                    <div style={{ ...detailValueStyle, color: '#d81b60', fontWeight: '700', fontSize: '1.2rem' }}>
                      {formatCurrency(order.totalAmount, settings.currency, settings.language)}
                    </div>
                  </div>
                ...
                <div style={itemsListStyle}>
                  ...
                  {order.items.map(item => (
                    <div key={item.id} style={{
                      ...
                      <div style={{ fontWeight: '600', color: '#d81b60' }}>
                        {formatCurrency(item.unitPrice * item.quantity, settings.currency, settings.language)}
                      </div>
                    </div>
                  ))}
                </div>
