...
const Signup: React.FC = () => {  const [firstName, setFirstName] = useState('');
  ...
  const translations: Record<string, Record<string, string>> = {
    ...
    fa: {
      ...
      createAccountDesc: 'آیا قبلا حسابی دارید؟',
      loginLink: 'ورود',
      firstName: 'نام',
      ...
      agreeToTerms: 'من با شرایط و ضوابط موافق هستم',
      createAccountBtn: 'ایجاد حساب',
      orRegisterWith: 'یا ثبت نام با',
      google: 'Google',
      apple: 'Apple',
      ...
      mustAgreeToTerms: 'شما باید شرایط و ضوابط را قبول کنید'
    },
    es: {
        ...
        <div style={formContainerStyle}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button 
              ...
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#f06292'}
